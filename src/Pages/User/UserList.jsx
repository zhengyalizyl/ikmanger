...
import {  getStudentDataAction} from "./../../Store/actionCreator";
                        ...
                        <div className="panel-body">
                            ...
                            <table className="table table-striped table-bordered table-hover">
                                ...
                                {studentData.map((student,index)=>{
                                        return (
                                            <tr key={index}>
                                         <td>{1+index+(this.state.pageNum-1)*this.state.pageSize}</td>
                                        ...
                                        <td>
                                            <Link to="/user/center" className="btn btn-info btn-xs">查看</Link>
